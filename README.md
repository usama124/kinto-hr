...
- `apps/api`: NestJS health/authentication endpoints, server-side tenant selection, protected account requests, owner membership administration, tenant security-audit access, organization/policy/catalog administration, effective entitlements, and safe HTTP boundary.
