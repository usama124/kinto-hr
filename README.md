...
- Optional OIDC login/callback, Redis server sessions, CSRF-protected logout and an account-access page. A pinned Keycloak LoA 2 profile and real browser/TOTP/email fixture are locally verified; authentication remains disabled by default.
