...
- Owner/HR employee roster, complete monthly-salaried draft creation, capacity-backed activation and rehire with tenant-scoped organization references, retained employment periods, cycle-safe effective-dated reporting assignments, versioned public profile edits and separately loaded/versioned private contact, emergency, address and CNIC details. Private values stay outside roster/audit/outbox projections; bank and salary data remain unavailable.
