...
- `apps/api`: NestJS health/authentication endpoints, server-side tenant selection, protected company/employee/administrator account requests, owner membership administration, and safe HTTP boundary.
