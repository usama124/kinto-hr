...
- `apps/api`: NestJS health/authentication endpoints, protected company/employee/administrator account requests, owner membership administration, and safe HTTP boundary.
