...
- `apps/api`: NestJS health/authentication endpoints, protected company/employee account requests, owner membership administration, and safe HTTP boundary.
