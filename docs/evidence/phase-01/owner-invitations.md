...
Employee provider reconciliation/setup/activation is now locally implemented; see [employee activation evidence](employee-account-activation.md). Next P01-02 work is membership administration and last-owner protection. See [authentication operations](../../operations/authentication.md), [Keycloak operations](../../operations/keycloak.md) and the [Phase 1 specification](../../implementation/PHASE-01-PLATFORM-PEOPLE.md).
