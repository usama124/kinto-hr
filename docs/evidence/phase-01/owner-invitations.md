...
The disposable realm grants broad management scope only to make its generated import portable; production must map and review least-privilege user-management roles. Production email/Keycloak infrastructure, secrets, alerts, identity-disable synchronization, failure reconciliation and recovery approval remain gates. No employee account provisioning, membership administration, last-owner protection, company setup UI or customer security-audit UI is included.

Next P01-02 work is company-owner/authorized-HR employee account provisioning, followed by membership administration and last-owner protection. See [authentication operations](../../operations/authentication.md), [Keycloak operations](../../operations/keycloak.md) and the [Phase 1 specification](../../implementation/PHASE-01-PLATFORM-PEOPLE.md).
