...
Employee and administrator provider reconciliation/setup/activation plus owner membership administration/last-owner protection and [server-side tenant selection](tenant-selection.md) are now locally implemented; see [employee activation evidence](employee-account-activation.md), [administrator invitation evidence](administrator-invitations.md) and [membership-administration evidence](membership-administration.md). Next P01-02 work is customer security-audit access. See [authentication operations](../../operations/authentication.md), [Keycloak operations](../../operations/keycloak.md) and the [Phase 1 specification](../../implementation/PHASE-01-PLATFORM-PEOPLE.md).
