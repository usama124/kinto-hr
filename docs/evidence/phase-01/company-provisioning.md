...
Subsequent increments locally implement [initial-owner activation](owner-invitations.md), [employee account provisioning/activation](employee-account-activation.md) and [owner membership administration with last-owner protection](membership-administration.md). Durable provider delivery/reconciliation remains a production gate; administrator invitations, tenant selection and customer security-audit access remain pending.
