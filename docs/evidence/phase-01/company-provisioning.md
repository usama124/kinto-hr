...
Subsequent increments locally implement [initial-owner activation](owner-invitations.md), [employee account provisioning/activation](employee-account-activation.md), [owner membership administration with last-owner protection](membership-administration.md) and [administrator invitations](administrator-invitations.md). Durable provider delivery/reconciliation remains a production gate; tenant selection and customer security-audit access remain pending.
