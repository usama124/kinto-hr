...
The next application slice is administrator-only platform/company/employee provisioning and invitation activation, followed by membership administration, last-owner protection and security audit. No signup or employee business endpoint was added. See [authentication operations](../../operations/authentication.md) and the [roadmap](../../implementation/README.md).
