...
The subsequent [initial-owner invitation increment](owner-invitations.md) locally verifies administrator-only company-owner setup and activation. Employee provisioning, membership administration, last-owner protection and security audit remain next. No signup or employee business endpoint was added. See [authentication operations](../../operations/authentication.md) and the [roadmap](../../implementation/README.md).
