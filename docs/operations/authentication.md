...
The first-operator, atomic company request and Keycloak initial-owner activation boundary are implemented; see [company-request evidence](../evidence/phase-01/company-provisioning.md) and [owner-invitation evidence](../evidence/phase-01/owner-invitations.md). Next: company-admin/HR employee invitations, membership administration and last-owner protection. Provider delivery failure/reconciliation and identity-disable synchronization remain production recovery gates. Company/policy administration and employee HTTP APIs remain closed until their authorization/lifecycle requirements are complete. See the [roadmap](../implementation/README.md).
