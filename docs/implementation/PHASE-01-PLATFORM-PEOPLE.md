...
- Acceptance: no full Phase 1 acceptance. P01-01 local engineering includes database recovery and worker monitoring; deployed backup/PITR/file recovery, alert notification delivery and staging review remain. P01-02 is locally verified as recorded in [organization-policy evidence](../evidence/phase-01/organization-policies.md). P01-03 is locally verified in [base-entitlement evidence](../evidence/phase-01/base-entitlements.md) and [entitlement-control evidence](../evidence/phase-01/entitlement-controls.md). P01-04 now has versioned department/designation catalogs with forced-RLS isolation and responsive owner controls; see [organization-catalog evidence](../evidence/phase-01/organization-catalogs.md). Full employee/compensation lifecycle and imports/private files are still required. No complete employee CRUD, invoice or payroll endpoint is exposed.
- Migration evidence: seventeen migrations are applied locally; isolated previous-schema upgrade/backfill, explicit first-operator bootstrap/replay, two-tenant delivery isolation and migration replay are verified. Local synthetic database restore includes identity/organization/catalog history plus entitlements; fresh-cluster/PITR/file recovery and staging evidence remain pending.
