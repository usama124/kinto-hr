...
Latest bounded P01-04 increment: [complete employee activation evidence](../evidence/phase-01/employee-activation.md) connects complete drafts to explicit, serialized subscription-capacity allocation. [Employee-record evidence](../evidence/phase-01/employee-records.md) covers the draft and assignment prerequisite. Termination/archive/rehire, private details, compensation and checklists remain.
