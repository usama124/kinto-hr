...
Latest bounded P01-04 increment: [scheduled termination evidence](../evidence/phase-01/employee-termination.md) applies an approved final working date idempotently and revokes linked company access. [Complete employee activation evidence](../evidence/phase-01/employee-activation.md) covers serialized subscription-capacity allocation. Archive/rehire, private details, compensation and checklists remain.
