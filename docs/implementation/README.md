...
Latest bounded P01-02 increment: [tenant-selection evidence](../evidence/phase-01/tenant-selection.md) adds active-company discovery, automatic single-company selection, explicit CSRF-protected multi-company choice and selected-tenant enforcement at every tenant-scoped HTTP boundary. Selection stays in the server session, grants no authority by itself and is cleared when access is revoked or the company is suspended. It builds on [administrator invitations](../evidence/phase-01/administrator-invitations.md), [membership administration](../evidence/phase-01/membership-administration.md) and the existing OIDC/session boundary. Authentication/provider provisioning remain disabled by default. Next is customer-visible security audit.
