...
Latest bounded P01-04 increment: [employee archive evidence](../evidence/phase-01/employee-archive.md) preserves completed employment history behind an explicit audited transition. [Scheduled termination evidence](../evidence/phase-01/employee-termination.md) covers final working dates and linked company-access revocation. Rehire, private details, compensation and checklists remain.
