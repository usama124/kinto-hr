...
Latest bounded P01-04 increment: [employee rehire evidence](../evidence/phase-01/employee-rehire.md) appends a new capacity-backed employment period and assignment while preserving prior history and revoked access. [Employee archive evidence](../evidence/phase-01/employee-archive.md) covers the preceding non-destructive transition. Private details, compensation and checklists remain.
