...
The first delivery is the safe **P00-04 / P01-01 foundation slice**, with evidence in [the foundation record](../evidence/phase-01/foundation.md). The next P01-01 slice adds the local worker/runtime and migration regression coverage; see [worker evidence](../evidence/phase-01/worker.md) and [operating procedures](../operations/foundation.md). P00-01 still needs owner-approved pilot details. Next engineering work completes recovery/operating evidence and P01-02 OIDC/membership authorization before employee endpoints are exposed. K50 hardware and payroll review gates remain external dependencies.
