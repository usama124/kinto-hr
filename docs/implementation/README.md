...
Latest bounded P01-04 increment: [effective-dated compensation evidence](../evidence/phase-01/employee-compensation.md) records permission-separated PKR salary snapshots without calculation. [Private-details evidence](../evidence/phase-01/employee-private-details.md) and the public lifecycle through [rehire](../evidence/phase-01/employee-rehire.md) precede it. Checklists remain.
