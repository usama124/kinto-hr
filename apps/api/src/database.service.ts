...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  createEmployeeImportPreview(
    ...
    return createTenantEmployeeImportPreview(
      this.db,
      actor,
      tenantId,
      requestKey,
  ...
  registerEmployeeDocument(
    ...
    return registerTenantEmployeeDocument(
      this.db,
      actor,
      tenantId,
      employeeId,
  ...
  authorizeEmployeeDocumentDownload(
    actor: { identityId: string; mfaVerified: boolean },
    tenantId: string,
    employeeId: string,
    documentId: string,
  ) {
    return authorizeTenantEmployeeDocumentDownload(
      this.db,
      actor,
      tenantId,
      employeeId,
  ...
  readSelfEmployeeDocuments(
    ...
    return readTenantSelfEmployeeDocuments(this.db, actor, tenantId);
  }
  authorizeSelfEmployeeDocumentDownload(
    actor: { identityId: string; mfaVerified: boolean },
    tenantId: string,
    documentId: string,
  ) {
    return authorizeTenantSelfEmployeeDocumentDownload(
      this.db,
      actor,
      tenantId,
      documentId,
  ...
  submitSelfProfileChangeRequest(
    actor: { identityId: string; mfaVerified: boolean },
    tenantId: string,
    requestKey: string,
    input: EmployeeProfileChangeRequestInput,
  ) {
    return submitTenantSelfProfileChangeRequest(
      this.db,
      actor,
      tenantId,
      requestKey,
  ...
  readEmployeeCompensation(
    actor: { identityId: string; mfaVerified: boolean },
    tenantId: string,
    employeeId: string,
  ) {
    return readTenantEmployeeCompensation(this.db, actor, tenantId, employeeId);
  }
  reviseEmployeeCompensation(
    actor: { identityId: string; mfaVerified: boolean },
    tenantId: string,
    employeeId: string,
    input: EmployeeCompensationRevision,
  ) {
    return reviseTenantEmployeeCompensation(
      this.db,
      actor,
      tenantId,
      employeeId,
