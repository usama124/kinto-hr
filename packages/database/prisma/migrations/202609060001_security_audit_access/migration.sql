...
CREATE FUNCTION public.list_tenant_security_audit(
...
REVOKE ALL ON FUNCTION public.list_tenant_security_audit(
  uuid, boolean, uuid, integer, varchar, timestamptz, timestamptz, uuid
) FROM PUBLIC;
